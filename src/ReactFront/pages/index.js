  ...
  return (
    <Layout pageTitle="Blog" path={router.pathname}>
      ...
      <div>
        ...
        <ul>
          <li><a href="http://api.localhost:8080/net/api/books">Api .NET</a></li>
          <li><a href="http://api.localhost:8080/js/api/books">Api NodeJS</a></li>
          <li><a href="http://api.localhost:8080/pgrest/books">Api PostgREST</a></li>
        </ul>
      </div>
      <br />
